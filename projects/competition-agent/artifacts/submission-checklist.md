...
- [ ] 评委能在 1 分钟内理解项目解决什么问题
- [ ] Demo 能在 3 到 5 分钟内展示闭环
- [ ] Skill 不是只生成文档，而是体现状态、Roadmap、DoD、Judge 和 Next Best Action
- [ ] 材料没有承诺 V1 做不到的功能
- [ ] 所有核心术语前后一致：Competition Agent、总控 Agent、Goal -> Plan -> Execute -> Judge -> Improve -> Deliver
